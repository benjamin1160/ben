...
export const metadata = {
  ...
  description:
    "What to expect now that your Florida home application is in. A real person calls within one business day.",
};

export default function SickOfRentingThankYou() {
  return (
          ...
          <div className="mx-auto max-w-3xl px-5 py-14">
            ...
            <ol className="mt-8 space-y-6">
              <Step
                ...
                body="From a 941, 813, 407, or 904 area code (it depends on which specialist gets your file). Save it in your contacts as “Florida Home Path” so it doesn't go to spam."
              />
              <Step
                num="02"
                when="Within 1 business day"
                title="A real person calls you."
                body="One licensed Florida ownership specialist — not a call center, not a bot, not a transfer chain. They'll have read your application before they dial. The call runs about 10–15 minutes."
              />
              <Step
                num="03"
                when="If it&apos;s a fit"
                title="A short list of real homes in your range."
                body="Sent the same day, with all-in monthly payments — not teaser numbers. You decide what to look at next. There's no pressure, no “sign here today,” no surprise credit pull."
              />
              <Step
                num="04"
                when="If it&apos;s not"
                title="An honest answer + a plan."
                body="If now isn't the right time, the specialist tells you exactly what to fix and when to come back. That part is free too."
              />
            </ol>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-3xl px-5 py-14">
            <div className="rounded-3xl border border-brand/30 bg-white p-6 shadow-sm sm:p-10">
              ...
              <p className="mt-3 text-base text-muted">
                ...
                stay first in line, and you don&apos;t have to wonder when the
                phone&apos;s going to ring.
              </p>
              <div className="mt-6 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                <Link
                  href="/sick-of-renting/booking"
          ...
          <div className="mx-auto max-w-3xl px-5 py-14">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <Action
                ...
                body="Add “Florida Home Path” with a Florida area code. Florida specialists call from 941, 813, 407, or 904 numbers."
              />
              <Action
                num="2"
                title="Whitelist our email."
                body="Move our welcome email out of Promotions. The home shortlist comes by email and you don&rsquo;t want it buried."
              />
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-border bg-slate-900 text-white">
          <div className="mx-auto max-w-3xl px-5 py-14 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-base text-slate-300">
              The math, the homes, the catch. It&apos;s the same page warm
              buyers spend 5–7 minutes on before the call. Worth it.
            </p>
        ...
        <footer className="border-t border-border bg-white">
          <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-3 px-5 py-8 text-xs text-muted sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://github.com/benjamin1160/ben/tree/main/app/sick-of-renting/thank-you"
                target="_blank"
  ...
  return (
    <li className="grid gap-4 rounded-2xl border border-border bg-white p-6 shadow-sm sm:grid-cols-[64px_1fr] sm:p-7">
      ...
      <div>
        ...
        <h3
          className="mt-1 text-lg font-semibold tracking-tight text-slate-900 sm:text-xl"
