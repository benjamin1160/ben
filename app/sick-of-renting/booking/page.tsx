...
export default function SickOfRentingBooking() {
  return (
      ...
      <main className="flex-1 bg-slate-50">
        <section className="border-b border-border bg-white">
          <div className="mx-auto max-w-3xl px-5 py-12 sm:py-16">
            ...
            <p className="mt-4 text-lg text-muted sm:text-xl">
              Lock in a 15-minute slot with a licensed Florida ownership
              specialist. One human, one call. They&apos;ll have read your
              file before they dial.
            </p>

            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <Trust title="15 minutes" body="No more, no less. We respect your day." />
              <Trust
                title="One human"
          ...
          <div className="mx-auto max-w-3xl px-5 py-12 sm:py-16">
            ...
            <ol className="mt-8 space-y-4">
              <Bullet
                ...
                body="Credit estimate, income, savings, monthly debt. We&rsquo;ll tell you, honestly, what budget is realistic — even if it&rsquo;s not the one you typed in."
              />
              <Bullet
                num="02"
                title="What homes are available right now."
                body="A specific shortlist in your county and price range, with all-in monthly payments. Sent the same day if it&rsquo;s a fit."
              />
              <Bullet
                num="03"
                title="The honest catch."
                body="Inventory in this band is tight. Closes typically run 60–120 days. We&rsquo;ll tell you whether the timing actually works — or whether to come back in 3 months."
              />
            </ol>
          </div>
        </section>
        ...
        <section className="border-t border-border bg-surface">
          <div className="mx-auto max-w-3xl px-5 py-12 text-center">
            ...
            <div className="mt-5">
              <Link
                href="/sick-of-renting/application"
        ...
        <footer className="border-t border-border bg-white">
          <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-3 px-5 py-8 text-xs text-muted sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://github.com/benjamin1160/ben/tree/main/app/sick-of-renting/booking"
                target="_blank"
