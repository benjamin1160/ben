            ...
            <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-5 py-12 md:grid-cols-2 md:py-20">
              <div className="flex flex-col justify-center">
                ...
                <p className="mt-5 max-w-xl text-lg text-muted sm:text-xl">
                  ...
                  . Tell us three things and a real person calls you back
                  today.
                </p>
              ...
              <div className="relative">
                <div className="absolute -inset-6 -z-10 rounded-[2rem] bg-gradient-to-br from-brand/20 via-brand/10 to-accent/20 blur-2xl" />
                <SqueezeForm />
              </div>
            </div>
          </section>
