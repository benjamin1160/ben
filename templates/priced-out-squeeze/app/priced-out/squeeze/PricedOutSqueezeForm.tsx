...
export default function PricedOutSqueezeForm() {
    ...
    return (
      <div className="rounded-2xl border border-border bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-muted">
          ...
          a shortlist of homes that actually fit your budget — not the bank&apos;s max.
        </p>
      </div>
    );
  }
  ...
  return (
    <form
      ...
      aria-label="See homes that fit your budget"
    >
      <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
        See what actually fits.
      </h2>
      <p className="mt-2 text-sm text-muted">
        Three fields. We&apos;ll send a real shortlist with all-in payments —
        not teaser numbers.
      </p>
      ...
      <div className="mt-6 grid gap-3">
        ...
        <label className="block">
          <span className="text-sm font-medium text-slate-700">
            What did the bank pre-approve you for?
          </span>
          <select
            required
