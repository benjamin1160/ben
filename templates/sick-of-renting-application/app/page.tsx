...
import ApplicationForm from "./sick-of-renting/application/ApplicationForm";

export const metadata = {
  title: "Florida Home Application — Sick of Renting",
  description:
    "The full application for Florida renters serious about owning. Reviewed by a human, called within one business day. No credit pull.",
};
        ...
        <section className="border-b border-border bg-white">
          <div className="mx-auto max-w-3xl px-5 py-12 sm:py-16">
            ...
            <p className="mt-4 text-lg text-muted sm:text-xl">
              You&apos;ve seen what the path looks like. This is the next step:
              a real application a real human will read before they call you.
              Honest answers get honest answers back.
            </p>
        ...
        <footer className="border-t border-border bg-white">
          <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-3 px-5 py-8 text-xs text-muted sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/grab/sick-of-renting/application"
